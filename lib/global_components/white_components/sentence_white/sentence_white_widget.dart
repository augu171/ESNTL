...
import 'sentence_white_model.dart';
export 'sentence_white_model.dart';

class SentenceWhiteWidget extends StatefulWidget {
  const SentenceWhiteWidget({
    super.key,
    String? content1,
    Color? pointColor,
    String? content2,
  ...
  @override
  State<SentenceWhiteWidget> createState() => _SentenceWhiteWidgetState();
}

class _SentenceWhiteWidgetState extends State<SentenceWhiteWidget> {
  late SentenceWhiteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SentenceWhiteModel());
  }
